...
-- 数据库连接信息
-- =====================================================
-- 地址: jdbc:mysql://62.234.128.72:3306/ideaspark
-- 用户名: ideaspark
-- 密码: icG62wSHYaaPKGX6
--
-- 执行方法（任选其一）：
-- 1. Navicat: 连接到数据库 -> 右键 -> 执行 SQL 文件
-- 2. DataGrip: 连接到数据库 -> 控制台 -> 粘贴执行
-- 3. 命令行: mysql -h 62.234.128.72 -P 3306 -u ideaspark -p ideaspark < notifications_migration.sql
-- =====================================================
